...
class GenerateDescriptionPage2 extends StatefulWidget {
  @override
  _GenerateDescriptionPage2State createState() => _GenerateDescriptionPage2State();
}

class _GenerateDescriptionPage2State extends State<GenerateDescriptionPage2> {
  File? _imageFile;
  ...
  Future<void> generateDescription(File imageFile) async {
    final Uri apiUrl = Uri.parse('https://api-inference.huggingface.co/models/Salesforce/blip-image-captioning-base');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('blip-image-captioning', style: TextStyle(color: Colors.white)),
